...
My current research primarily focuses on LLM + GNN + XAI with two main objectives: 1. **How LLMs understand textual graphs**. Studying LLMs on textual graphs can enhance their ability to understand complex relationships and better preserve semantic and topological information, improving the effectiveness of graph data processing. 2. **Explore graph structures crucial for LLM development in real-world production settings and applications.** 
